...
const Approach = () => {
    return (
        <div id="approach" className="text-left mx-auto mt-[150px] max-w-[700px] md:w-[650px] w-full max-sm:w-[360px]">
            ...
            <div className="flex-none lg:w-[350px] mt-[50px] lg:h-[300px] md:w-[300px] md:h-[250px] sm:w-[250px] sm:h-[200px] max-sm:w-[200px] max-sm:h-[170px] max-md:flex max-md:justify-center mx-auto">

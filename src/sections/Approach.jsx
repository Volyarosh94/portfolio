...
const Approach = () => {
    return (
        <div id="approach" className="lg:col-start-4 lg:col-end-10 max-sm:mx-auto  text-left mx-[30px] lg:mt-[300px] md:mt-[200px] sm:mt-[170px] max-sm:mt-[150px] max-w-[800px] md:w-[650px] max-sm:w-[360px]">
            <div className="mb-4 font-normal text-[#282B26] lg:leading-[40px] md:leading-[40px] sm:leading-[35px] max-sm:leading-[30px] lg:w-[800px] lg:text-[22px] md:text-[20px] sm:text-[18px] font-normal font-firaSansRegular leading-normal md:w-[650px]">
            ...
            <div className="lg:col-start-3 lg:col-end-7 lg:text-left lg:flex lg:justify-start lg:w-[440px] lg:h-[350px] mt-[50px] md:w-[300px] md:h-[250px] sm:w-[250px] sm:h-[200px] max-sm:w-[200px] max-sm:h-[260px] max-sm:w-[320px]">

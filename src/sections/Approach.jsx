...
const Approach = () => {
    return (
        <div id="approach" className="text-left mx-auto mt-[150px] max-w-[700px] md:w-[650px] max-sm:w-[360px]">
            ...
            <div className="flex flex-col lg:text-left lg:flex lg:justify-start lg:w-[300px] lg:h-[250px] mt-[50px] md:w-[300px] md:h-[250px] sm:w-[250px] sm:h-[200px] max-sm:w-[200px] max-sm:h-[260px] max-sm:w-[320px]">

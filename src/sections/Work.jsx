...
const Work = () => {
    return (
        <div id="work" className="lg:col-start-3 lg:col-end-11 text-left mx-auto lg:mt-[250px]  md:mt-[250px] sm:mt-[200px] max-sm:mt-[150px] max-w-[1400px] lg:w-[1070px] w-full md:w-[670px] max-sm:w-[370px]">

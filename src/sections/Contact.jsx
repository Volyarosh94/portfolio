...
const Contact = () => {
    ...
    return (
        ...
        >
            <p className="lg:text-[22px] lg:w-[800px] md:text-[20px] sm:text-[18px] max-sm:text-[18px] lg:leading-[40px] md:leading-[40px] sm:leading-[35px] max-sm:leading-[30px] font-fira font-[300] leading-relaxed text-[#282B26]">
            ...
            <div className="flex flex-col lg:gap-4 max-sm:gap-2 md:gap-3 mt-[50px] lg:mt-[100px] text-lg">
                <div className="flex items-center">
                    <img src={PhoneIcon} alt="Phone" className="mr-2 w-[20px] h-[20px]" />
                    <span className="max-sm:text-[16px] lg:text-[22px] md:text-[20px] sm:text-[18px] max-sm:text-[18px] font-fira font-[300] text-[#282B26]">
                        +49 (0) 1525 1936697
                    </span>
                </div>
                <div className="flex items-center">

...
const Contact = () => {
    return (
        <div id="contact" className="text-left lg:w-[700px] md:w-6450px] lg:ml-[240px] mt-[200px]">
            <p className='font-fira-sans lg:text-lg text-lg font-normal leading-relaxed text-[282B26]'>I would love to hear from you, especially if you are interested in working
            ...
            <div>
                <img src={Smile} alt="‘A close-up image of a round, white sticker with a friendly, minimalist yellow smiley face at its center. The phrase (LET'S TALK) is printed in a continuous loop around the edge of the circle, emphasising an open invitation to communicate with the above contact details.’"
                    className="lg:w-[150px] lg:h-[150px] mt-[50px] max-sm:w-[100px] max-sm:h-[100px] md:w-[100px] md:h-[100px]" />
            </div>
        </div>
    )
}

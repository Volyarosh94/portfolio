...
const Contact = () => {
    ...
    return (
        <div
            ref={contactRef}
            id="contact"
            className="lg:col-start-4 lg:col-end-10 max-sm:mx-auto text-left mx-[30px] md:mb-4 sm:mb-4 max-sm:mb-4 lg:top-0 lg:mt-[410px] md:mt-[250px] sm:mt-[200px] max-sm:mt-[260px] max-w-[800px] md:w-[650px] max-sm:w-[355px]"
        >

        ...
        >
            ...
            <div>
                <img
                    ...
                    className="lg:w-[260px] lg:h-[260px] lg:mt-[100px] max-md:w-[170px] max-md:h-[170px] mt-[50px] max-sm:w-[150px] max-sm:h-[150px] md:w-[200px] md:h-[200px] border-[1.5px] border-gray-200 rounded-full"
                />
            </div>
        </div>
    );

...
const Intro = () => {
    return (
        <div>
            <div id="intro" className='flex-1 mx-auto max-w-[685px] max-sm:w-[360px] mt-[10px]'>
                ...
                <div className='lg:flex sm:flex-col sm:items-center lg:flex-row lg:w-[700px] md:w-[650px] lg:gap-[80px] md:gap-[40px] mb-6 max-sm:justify-start'>
                    ...
                    <p className='max-sm:text-left lg:text-[20px] md:text-[18px] lg:mt-[25px] max-sm:text-full lg:max-w-xl lg:w-[500px] md:w-[650px] text-left text-md font-firaSansRegular leading-relaxed text-[282B26]'>

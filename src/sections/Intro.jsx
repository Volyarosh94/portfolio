...
import line from '../assets/svg/Outline (1).svg'
        ...
        <div id="intro" className='lg:col-start-4 max-sm:mx-auto lg:col-end-10 mx-[30px] flex-1 max-w-[900px] max-sm:w-[360px]'>
            <div className='max-md:text-[80px] lg:w-[800px] font-crimsonProSemi font-normal lg:text-[110px] text-[#282B26] md:text-[80px] max-sm:text-[40px] max-sm:mb-8 mt-[50px] text-left md:text-[70px] max-sm:text-[50px] leading-none'>
                <span className='relative inline-block'>
                    ...
                    <img src={line} alt="" className='absolute top-[85%]' />
                </span>
                <br />
                <span className='text-semibold'>Product Designer</span>
            </div>

            <div className='lg:flex sm:flex-col lg:w-[800px] lg:h-[300px] sm:items-center lg:flex-row md:w-[650px] lg:gap-[75px] md:gap-[40px] max-sm:justify-start'>
                ...
                <p className='lg:col-start-3 max-sm:text-left lg:text-[22px] lg:leading-[38px] md:leading-[40px] sm:leading-[35px] max-sm:leading-[30px] md:text-[19px] sm:text-[18px] lg:mt-[10px] max-sm:text-[18px] lg:max-w-xl lg:w-[700px] md:w-[650px] text-left text-md font-fira font-[300] leading-relaxed text-[#282B26]'>

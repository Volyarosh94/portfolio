...
const Intro = () => {
    return (
        <div>
            <div id="intro" className='flex-1 mx-auto max-w-[685px] max-sm:w-[380px] mt-[50px]'>
                ...
                <div className='lg:flex sm:flex-col sm:items-center lg:flex-row lg:w-[700px] md:w-[650px] lg:gap-[80px] md:gap-[40px] mb-6 max-sm:justify-start'>
                    <div className='relative max-sm:flex max-sm:flex-col max-md:flex max-md:mb-[50px] md:items-start max-md:items-start max-sm:items-start md:flex md:justify-start md:mb-[30px] max-sm:mt-[50px] md:mt-[70px] max-md:mt-[70px]'>
                        <img className="lg:left-[85%] lg:bottom-[85%] absolute lg:w-[65px] lg:h-[65px] md:w-[80px] md:h-[80px] md:left-[27%] md:bottom-[85%] md:w-[70px] md:h-[70px] sm:left-[28%] sm:bottom-[85%] sm:w-[70px] sm:h-[70px] max-sm:w-[70px] max-sm:h-[70px] max-sm:left-[43%] max-sm:bottom-[85%] drop-shadow-lg" src={pen} alt="pencil" />

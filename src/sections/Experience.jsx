...
const Experience = () => {
    return (
        <div id="experience" className="lg:col-start-4 lg:col-end-10 max-sm:mx-auto  text-left mx-[30px] lg:mt-[250px]  md:mt-[250px] sm:mt-[200px] max-sm:mt-[150px] max-w-[800px] md:w-[650px] max-sm:w-[355px]">
            <div>
                <p className="text-[#282B26] lg:w-[800px] lg:leading-[40px] md:leading-[40px] sm:leading-[35px] max-sm:leading-[30px] lg:text-[22px] md:text-[20px] sm:text-[18px] max-sm:text-[18px] text-md font-fira font-[300] leading-relaxed md:w-[650px] max-sm:w-[360px]">
            ...
            <div className="flex flex-col lg:w-[800px] items-center lg:mt-[100px] md:mt-[60px] max-md:mt-[40px] max-sm:mt-[40px] justify-center">
                <div className="flex w-full justify-center max-sm:justify-start lg:gap-[70px] md:gap-[40px] max-md:gap-[30px]">
                    ...
                    <img src={keyWord} alt="five company logos arranged in two rows: Top row shows N26 (stylized with a line above), Javelin, and Key Ward. Bottom row displays CitizenTech (with a globe icon) and tado° (styled with a degree symbol). All logos are presented in black against a light background." className="lg:h-[50px] lg:mt-[10px] md:h-[50px] max-md:h-[20px] sm:h-[50px] mx-2" />
                </div>
                <div className="flex justify-center mt-10 lg:mt-[60px] lg:gap-[70px] md:gap-[60px] max-md:gap-[40px]">

...
const Experience = () => {
    return (
        <div id="experience" className="text-left mx-auto lg:mt-[300px] md:mt-[250px] sm:mt-[200px] max-sm:mt-[150px] max-w-[800px] w-full md:w-[650px] max-sm:w-[355px]">
            <div className="mt-[20px]">
                <p className="text-[#282B26] lg:w-[730px] font-fira-sans lg:text-[20px] md:text-[20px] sm:text-[18px] text-md font-firaSansRegular font-normal leading-relaxed md:w-[650px] max-sm:w-[360px]">
            ...
            <div className="flex flex-col items-center mt-[40px] justify-center">
                <div className="flex w-full justify-center lg:gap-[50px] md:gap-[60px] max-md:gap-[40px]">

const Image = ({ image1, image2, layout }) => {
    if (layout === "column") {
        return (
            <div className="flex flex-col gap-4 max-sm:gap-0 max-md:items-center max-md:mb-[20px]">
                <div className="w-[300px] h-[320px] md:w-[260px] md:h-[300px] max-md:w-[380px] max-md:h-[250px] max-sm:w-[230px] max-sm:h-[200px] flex justify-center items-center">
                    <img
    ...
    if (layout === "phone") {
        return (
            <div className="relative h-[320px] w-full flex justify-center items-center">
                <div className="relative w-[220px] h-[220px] mt-16">
                    <img
                        className="w-full h-full md:w-[200px] md:h-[200px] object-cover max-sm:w-[200px] max-sm:h-[200px]"
                        src={image1}
                ...
                <div className="absolute left-[60%] top-[0%] w-[200px] h-[300px] max-sm:w-[200px] max-sm:h-[270px] md:left-[55%] max-sm:left-[40%] max-sm:top-[1%] md:left-[50%] max-md:top-[-1%] max-md:left-[55%]">
                    <img
                        className="w-full h-full md:w-[120px] md:h-[300px] object-contain"
                        src={image2}
                        alt="A close-up image of a person next to their bike, holding a smartphone which displays the parry app, openon the map view. This image is overlayed with a second image, displaying a direct view of the parry app, open on the 'my spots' page. This page shows a segmented control, with 'Reported spots' selected, and another option to view 'Voted Spots'. The list of reported spots is currently ranked by most recent, with a dropdown menue offering other ranking options. This page also displays an app navigation bar at the bottom of the page, and a token balance at the top of the page next to the user's profile image."
                    />
                </div>
    ...
    if (layout === "columnTwo") {
        return (
            <div className="flex flex-col max-md:flex-row max-md:gap-2 max-md:justify-center max-sm:mb-[20px] max-md:items-center">
    ...
    return (
        <div className="flex gap-4 lh-[300px] max-md:flex max-md:mb-[20px] max-md:justify-center max-md:items-center max-md:gap-8 lg:mb-8 md:mb-4 max-sm:mb-6">
            <div className="lg:w-1/2 md:w-[100px]">
                <img
                    className="lg:h-[300px] max-md:h-[300px] md:h-[250px] max-sm:h-[250px] rounded-xl"
                    src={image1}

const Image = ({ image1, image2, layout }) => {
    ...
    if (layout === "phone") {
        return (
            <div className="relative h-[320px] w-full flex justify-center items-center">
                ...
                <div className="absolute left-[60%] top-[0%] w-[200px] h-[300px] max-sm:w-[200px] max-sm:h-[270px] max-sm:left-[40%] max-sm:top-[1%] md:left-[50%] max-md:top-[-1%] max-md:left-[55%]">
                    <img
    ...
    if (layout === "columnTwo") {
        return (
            <div className="flex flex-col gap-4 max-md:flex-row max-md:gap-2 max-md:justify-center max-md:items-center">
                <div className="w-[220px] h-[160px] mb-6 max-sm:w-[180px] max-sm:h-[110px] max-sm:px-4 shadow-lg">
                    <img
    ...
    if (layout === "One") {
        return (
            <div className="flex flex-col gap-4 pl-[80px] lg:pl-[20px] max-md:flex max-md:justify-center max-md:items-center">
                <div className="lg:w-[400px] lg:h-[350px]  max-md:w-[370px] max-md:h-[320px] max-sm:w-[260px] max-sm:h-[230px] md:w-[360px] md:h-[350px]">
                    <img
    ...
    return (
        <div className="flex gap-4 h-[300px] max-md:flex max-md:justify-center max-md:items-center max-md:gap-8 lg:mb-8 md:mb-4 max-sm:mb-6">
            <div className="lg:w-1/2">
                <img
                    className="h-[300px] max-sm:h-[250px] rounded-xl"
                    src={image1}
